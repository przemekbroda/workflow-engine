...
public class NotValidProducedEventTreeProvider(IServiceProvider serviceProvider) : TreeProvider<TreeState, TreeEvent>(serviceProvider)
{
        ...
        return new EventNode<TreeState, TreeEvent>
        {
            ...
            [
                ...
                new EventNode<TreeState, TreeEvent>
                {
                    ...
                    ProducesEvents = ["Event41", "Event42", "Event43"],
                    NextExecutors =
                    [
                        new EventNode<TreeState, TreeEvent>
                        {
                            HandlesEvents = ["Event41", "Event42"],
                        ...
                        new EventNode<TreeState, TreeEvent>
                        {
                            HandlesEvents = ["Event43", "WeirdEvent"],
